...
for year in range(2017, 2023):  # This will include 2012 through 2023
    file_path = f'rivers/rivers({year}).csv'
    
    try:
        # Read the rivers data for this year
        rivers_df = pd.read_csv(file_path)
        ...
        output_filename = f'rivers_with_location_{year}.csv'
