...
if __name__ == "__main__":
    ...
    data_directory = '/home/acer/Music/DPPRO/slwqi'  # Update this to your directory path
    ...
    if combined_df is not None:
        ...
        if processed_df is not None:
            ...
            if validation_metrics_df is not None and not validation_metrics_df.empty:
                ...
                # Append to CSV
                append_to_csv(validation_metrics_df, '/home/acer/Music/DPPRO/rivers_with_locations/rlwqi/validation_metrics.csv', validation_key_columns)
            ...
            if not all_future_predictions.empty:
                ...
                # Append to CSV
                append_to_csv(all_future_predictions, '/home/acer/Music/DPPRO/rivers_with_locations/rlwqi/wqi_predictions.csv', prediction_key_columns)
